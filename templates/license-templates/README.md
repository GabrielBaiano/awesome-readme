...
# awesome-readme-templates / templates / license-templates
...
```
 ...
 - [AGPL-3.0-LICENSE.txt](./AGPL-3.0-LICENSE.txt) - [Apache-2.0-LICENSE.txt](./Apache-2.0-LICENSE.txt) - [BSD-2-Clause-LICENSE.txt](./BSD-2-Clause-LICENSE.txt) - [BSD-3-Clause-LICENSE.txt](./BSD-3-Clause-LICENSE.txt) - [GPL-3.0-LICENSE.txt](./GPL-3.0-LICENSE.txt) - [ISC-LICENSE.txt](./ISC-LICENSE.txt) - [MIT-LICENSE.txt](./MIT-LICENSE.txt) - [MPL-2.0-LICENSE.txt](./MPL-2.0-LICENSE.txt) - [README.md](./README.md) - [Unlicense-LICENSE.txt](./Unlicense-LICENSE.txt)
## Directory Tree
[<- Previous](s://github.com/GabrielBaiano/awesome-readme)
```
license-templates/
